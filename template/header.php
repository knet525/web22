...
<!-- Mirrored from htmlcoder.me/preview/the_project/v.1.4/template/index-corporate-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 Jan 2017 11:15:05 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="http://htmlcoder.me/preview/the_project/v.1.4/template/plugins/rs-plugin-5/js/jquery.themepunch.revolution.min.js?rev=5.0"></script>
    <style type="text/css">
        .baner-img{
            margin: auto;
        }
    ...
    <div class="header-container">
                    ...
                    <div class="col-xs-3 col-sm-6 col-md-9">
                        ...
                        <div class="header-top-first clearfix">
                            ...
                            <ul class="list-inline hidden-sm hidden-xs">
                                <li><i class="fa fa-map-marker pr-5 pl-10"></i>Vadali Sheri, Nani Bazaar, Gondal</li>
                                <li><i class="fa fa-phone pr-5 pl-10"></i>+91 (2825) 227510</li>
                                <li><i class="fa fa-envelope-o pr-5 pl-10"></i> trikamraijihaveli.gondal@gmail.com</li>
                            </ul>
                        </div>
        ...
        <!--div id="header-top-second"  class="clearfix">
                <ul class="list-inline">
                    <li><i class="fa fa-phone pr-5 pl-10"></i>+91 (2825) 227510</li>
                    <li><i class="fa fa-envelope-o pr-5 pl-10"></i> shritrikamrayjihaveli@gmail.com</li>
                </ul>
            <div class="header-top-dropdown text-right">
                <div class="btn-group">
                    <a href="page-signup.html" class="btn btn-default btn-sm"><i class="fa fa-user pr-10"></i> Sign Up</a>
                    ...
                    <div class="col-md-3 ">
                        ...
                        <div class="header-first clearfix">
                            ...
                            <div id="logo" class="logo">
                                <a href="#">
                                    <img class="img-logo" src="Assets/side_logo_new.jpg"></a>
                                <!-- <img id="logo_img" src="Assets/main_logo.png"></a> -->
                            </div>

                            <!-- name-and-slogan -->
                            <div class="site-slogan">
                                || Shri Trikamraiji Vijayte ||
                            </div>
                                        ...
                                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                            ...
                                            <ul class="nav navbar-nav ">
                                                ...
                                                <li class="dropdown  mega-menu">
                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Haveli.</a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-lg-8 col-md-9">
                                                                    <h4 class="title">Shri Kutchi Bhatia Trikamrayji Mandir (Shahbandarwala)</h4>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <!--div class="divider"></div-->
                                                                            <ul class="menu">
                                                                                <li ><a href="about-haveli.php"><i class="fa fa-angle-right"></i>About the Haveli</a></li>
                                                                                <li ><a href="page-coming-soon.html"><i class="fa fa-angle-right"></i>Shri Trikamraiji Swaroop</a></li>
                                                                                <li ><a ><i class="fa fa-angle-right"></i>Darshan Time & Manoraths</a></li>
                                                                                <li ><a href="page-coming-soon.html"><i class="fa fa-angle-right"></i>Bhatia Community</a></li>
                                                                                <li><a href="page-coming-soon.html"><i class="fa fa-angle-right"></i>Accomodation</a></li>
                                                                ...
                                                                <div class="col-lg-4 col-md-3 hidden-sm">
                                                                    <h4 class="title">Shri Trikamraiji </h4>
                                                                    <p class="mb-10">The Divine Swaroop of Shri Trikamraiji at Gondal</p>
                                                                    <img src="assets/images/Shri_trikamraiji.jpg" >
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="dropdown ">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="page-coming-soon.html">FAQ </a></li>
                                                        <li class="dropdown"> <a>Downloads</a>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="bhagwad_gita.php">Bhagwad Gita<span class="badge">Mp3</span></a></li>
                                                                <li><a href="list_of_bethakjis.php">List of Bethakjis <span class="badge">PDF</span></a></li>
                                                                <li><a href="page-coming-soon.html"> Krishna Jivan Charitra <span class="badge">PDF</span></a></li>
                                                                <li><a href="sudarshan_kavach.php">Sudarshan Kavach <span class="badge">MP3</span></a></li>

                                                            </ul>
                                                        </li>


                                                        <li class="dropdown"><a>Pushtimarg </a>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="brahmsambandh.php">Brahamsambandh</a></li>
                                                                <li><a href="yamunastak.php">Yamunastak</a></li>
                                                            </ul>
                                                        </li>
                                                ...
                                                <li class="dropdown ">
                                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Bhet</a>
                                                    <ul class="dropdown-menu">
                                                        <li><a href="manorath.php"> List of Manoraths</a></li>
                                                        <li><a href="online_bhet.php"> Book Online</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown ">
                                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">News & Events</a>
                                                    <ul class="dropdown-menu">
                                                        <li><a href="News_events.html"> Upcoming Events </a></li>
                                                        <li><a href="gallery_photos.php"> Gallery </a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a href="page-contact-2.html">Contact Us</a>
                                                </li>
                                                <!-- Additional data might need to delete -->
                                                </li>
                                                </li>
                                            </ul>
                                        </div>
